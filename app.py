...
def game():
    ...
    return render_template("game.html", player1=session["player1"], player2=session["player2"], 
                           score1=session["score1"], score2=session["score2"], 
                           current_player=session["current_player"], message = message)
